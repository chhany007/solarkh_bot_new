...
**ពាក្យបញ្ជា:**
• `/quote <kwh_ប្រចាំខែ> <តម្លៃ_ក្នុងមួយ_kwh>` - ទទួលបានសម្រង់តម្លៃផ្ទាល់ខ្លួន
  ឧទាហរណ៍: `/quote 300 0.15`

• `/template <ប្រភេទ> <តម្លៃ_ក្នុងមួយ_kwh>` - ទទួលបានសម្រង់តម្លៃពីគំរូ
  ប្រភេទ: តូច, មធ្យម, ធំ, រោងចក្រ
  ឧទាហរណ៍: `/template មធ្យម 0.15`

• `/language` - ប្តូរភាសា / Switch language
